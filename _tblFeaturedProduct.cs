...
{
	public abstract class _tblFeaturedProduct : SqlClientEntity
	{
		public _tblFeaturedProduct()
		{
			this.QuerySource = "tblFeaturedProduct";
			this.MappingName = "tblFeaturedProduct";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblFeaturedProductLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int AppFeaturedProductID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.AppFeaturedProductID, AppFeaturedProductID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblFeaturedProductLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter AppFeaturedProductID
			{
				get
				{
					return new SqlParameter("@AppFeaturedProductID", SqlDbType.Int, 0);
				}
			}
		...
		{  
            public const string AppFeaturedProductID = "appFeaturedProductID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[AppFeaturedProductID] = _tblFeaturedProduct.PropertyNames.AppFeaturedProductID;
					ht[AppProductID] = _tblFeaturedProduct.PropertyNames.AppProductID;
					ht[AppIsActive] = _tblFeaturedProduct.PropertyNames.AppIsActive;
					ht[AppDisplayOrder] = _tblFeaturedProduct.PropertyNames.AppDisplayOrder;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[AppFeaturedProductID] = _tblFeaturedProduct.ColumnNames.AppFeaturedProductID;
					ht[AppProductID] = _tblFeaturedProduct.ColumnNames.AppProductID;
					ht[AppIsActive] = _tblFeaturedProduct.ColumnNames.AppIsActive;
					ht[AppDisplayOrder] = _tblFeaturedProduct.ColumnNames.AppDisplayOrder;
		...
		{  
            public const string AppFeaturedProductID = "s_AppFeaturedProductID";
		...
		public virtual int AppFeaturedProductID
	    {
			get
	        {
				return base.Getint(ColumnNames.AppFeaturedProductID);
			}
			set
	        {
				base.Setint(ColumnNames.AppFeaturedProductID, value);
			}
		}
		...
		public virtual string s_AppFeaturedProductID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.AppFeaturedProductID) ? string.Empty : base.GetintAsString(ColumnNames.AppFeaturedProductID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.AppFeaturedProductID);
				else
					this.AppFeaturedProductID = base.SetintAsString(ColumnNames.AppFeaturedProductID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter AppFeaturedProductID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.AppFeaturedProductID, Parameters.AppFeaturedProductID);
			...
			public WhereParameter AppFeaturedProductID
		    {
				get
		        {
					if(_AppFeaturedProductID_W == null)
	        	    {
						_AppFeaturedProductID_W = TearOff.AppFeaturedProductID;
					}
					return _AppFeaturedProductID_W;
				}
			}
			...
			private WhereParameter _AppFeaturedProductID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter AppFeaturedProductID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.AppFeaturedProductID, Parameters.AppFeaturedProductID);
			...
			private AggregateParameter _AppFeaturedProductID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblFeaturedProductInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.AppFeaturedProductID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblFeaturedProductUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblFeaturedProductDelete]";
	
			SqlParameter p;
			p = cmd.Parameters.Add(Parameters.AppFeaturedProductID);
			p.SourceColumn = ColumnNames.AppFeaturedProductID;
