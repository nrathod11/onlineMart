...
{
	public abstract class _tblSubCategory : SqlClientEntity
	{
		public _tblSubCategory()
		{
			this.QuerySource = "tblSubCategory";
			this.MappingName = "tblSubCategory";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblSubCategoryLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int AppSubCategoryID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.AppSubCategoryID, AppSubCategoryID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblSubCategoryLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter AppSubCategory
			{
				get
				{
					return new SqlParameter("@AppSubCategory", SqlDbType.VarChar, 50);
				}
			}
		...
		{  
            ...
            public const string AppSubCategory = "appSubCategory";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[AppSubCategoryID] = _tblSubCategory.PropertyNames.AppSubCategoryID;
					ht[AppSubCategory] = _tblSubCategory.PropertyNames.AppSubCategory;
					ht[AppCategoryID] = _tblSubCategory.PropertyNames.AppCategoryID;
					ht[AppIsActive] = _tblSubCategory.PropertyNames.AppIsActive;
					ht[AppDisplayOrder] = _tblSubCategory.PropertyNames.AppDisplayOrder;
					ht[AppCreatedBy] = _tblSubCategory.PropertyNames.AppCreatedBy;
					ht[AppCreatedDate] = _tblSubCategory.PropertyNames.AppCreatedDate;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[AppSubCategoryID] = _tblSubCategory.ColumnNames.AppSubCategoryID;
					ht[AppSubCategory] = _tblSubCategory.ColumnNames.AppSubCategory;
					ht[AppCategoryID] = _tblSubCategory.ColumnNames.AppCategoryID;
					ht[AppIsActive] = _tblSubCategory.ColumnNames.AppIsActive;
					ht[AppDisplayOrder] = _tblSubCategory.ColumnNames.AppDisplayOrder;
					ht[AppCreatedBy] = _tblSubCategory.ColumnNames.AppCreatedBy;
					ht[AppCreatedDate] = _tblSubCategory.ColumnNames.AppCreatedDate;
		...
		{  
            ...
            public const string AppSubCategory = "s_AppSubCategory";
		...
		public virtual string AppSubCategory
	    {
			get
	        {
				return base.Getstring(ColumnNames.AppSubCategory);
			}
			set
	        {
				base.Setstring(ColumnNames.AppSubCategory, value);
			}
		}
		...
		public virtual string s_AppSubCategory
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.AppSubCategory) ? string.Empty : base.GetstringAsString(ColumnNames.AppSubCategory);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.AppSubCategory);
				else
					this.AppSubCategory = base.SetstringAsString(ColumnNames.AppSubCategory, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter AppSubCategory
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.AppSubCategory, Parameters.AppSubCategory);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter AppSubCategory
		    {
				get
		        {
					if(_AppSubCategory_W == null)
	        	    {
						_AppSubCategory_W = TearOff.AppSubCategory;
					}
					return _AppSubCategory_W;
				}
			}
			...
			private WhereParameter _AppSubCategory_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter AppSubCategory
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.AppSubCategory, Parameters.AppSubCategory);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _AppSubCategory_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblSubCategoryInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.AppSubCategoryID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblSubCategoryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblSubCategoryDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.AppSubCategory);
			p.SourceColumn = ColumnNames.AppSubCategory;
			p.SourceVersion = DataRowVersion.Current;
